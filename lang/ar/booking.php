...
return [
    ...
    */
    'tracking' => [
        ...
        'emergency_notice' => 'الحالات الطارئة لها الأولوية دائماً، لذلك قد يزيد عدد الحالات قبلك أثناء انتظارك.',
        'your_status' => 'حالتك الآن',
        'expected_at' => 'الوصول للعيادة',
        'call_clinic' => 'اتصال بالعيادة',
        'patient_code' => 'كود المريض',
        'appointment' => 'موعد الحجز',
        'your_turn' => 'دورك الآن',
        'first_in_line' => 'ترتيبك الأول',
        'first_in_line_note' => 'موعدك الساعة :time، ويفضل الحضور قبله بـ :lead.',
        'first_in_line_note_no_time' => 'لا يوجد أحد قبلك في الدور حالياً.',
        'your_turn_note' => 'من فضلك توجه إلى غرفة الكشف',
        'done' => 'تم الكشف',
        'done_note' => 'شكراً لزيارتك، نتمنى لك دوام الصحة',
        'cancelled' => 'الحجز ملغي',
        'cancelled_note' => 'من فضلك تواصل مع العيادة لحجز موعد جديد',
        'no_show' => 'لم يتم الحضور',
        'no_show_note' => 'من فضلك تواصل مع العيادة لحجز موعد جديد',
        'not_today' => 'موعدك لم يحن بعد',
        'not_today_note' => 'يظهر ترتيبك في الدور يوم الموعد.',
        'am' => 'ص',
        'pm' => 'م',
    ],
];
